...
with open('netflix_with_rating.csv', 'rb') as f:
    result = chardet.detect(f.read())  # or readline if the file is large
train = pd.read_csv('netflix_with_rating.csv', encoding=result['encoding'])
#print(train.id)
print(train)
...
clean_review = review_to_words( train["imdbID"][0] )
print(clean_review)
print("----------------------------")
# Get the number of reviews based on the dataframe column size
num_reviews = train["imdbID"].size
print(num_reviews)
print("----------------------------")
...
#for i in range( 0, 20 ):
 ...
 str = review_to_words(train["imdbID"][i] ) 
 #print (len(str))
 #print(i)
 if (len(str) > 0 ):
